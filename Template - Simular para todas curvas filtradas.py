...
INPUT_PATH = r'G:\Meu Drive\01 - Iniciação Científica/02 - Datasets/exoplanets_confirmed/folded_curves_with_error_fixed'
...
final_table.to_csv('FINAL_TABLE_with_fixed_uncertanties.csv', index=True)
